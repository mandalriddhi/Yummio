...
def get_restaurant_internal_traffic(gmaps_client, restaurant_id, restaurant_name):
    ...
    try:
        ...
        # Note: 'current_popularity' is not an official field in the Google Places API.
        # For real-world use, you'd need a third-party library like 'populartimes' or simulate it.
        # Here, we'll simulate based on time and day with realistic variation.
        
        # Define typical busy hours (peak times)
        peak_hours = {
        ...
        # Simulate internal traffic based on time
        if in_peak:
...
def calculate_total_traffic_score(road_traffic_seconds, internal_traffic_value):
    ...
    """
    # Convert internal traffic percentage to seconds (1% = 10 seconds of delay)
    internal_traffic_seconds = internal_traffic_value * 10
    total_traffic_seconds = road_traffic_seconds + internal_traffic_seconds
    
    # Determine status and color based on total traffic
...
excel_filename = "restaurants_with_traffic.xlsx"
