...
# New function to calculate travel time from main road to restaurant
...
# New function to find nearest point on main road
...
# Print grouped restaurant list with travel time
